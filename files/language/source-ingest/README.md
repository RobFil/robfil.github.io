...
Akzeptierter Kontext wird lokal unter `output/human/context.md` und `output/machine/context.jsonl` erzeugt. Der `teacher`-Skill nutzt diese Dateien als Lernbasis.
